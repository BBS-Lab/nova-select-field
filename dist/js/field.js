...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-select-field', __webpack_require__(3));
  Vue.component('detail-nova-select-field', __webpack_require__(6));
  Vue.component('form-nova-select-field', __webpack_require__(9));
});
